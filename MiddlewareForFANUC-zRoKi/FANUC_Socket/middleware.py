...
if __name__ == '__main__':
        ...
        #subscribe or unsubscribe to Data Source
        threading.Timer(1, Utility_FUNC.sub_or_Unsubscribe_DataSource,
                args=(ASYNCH_URL,ROBOT_ID,True)
                ).start()

        #threading.Timer(1, test).start()

        app.run(host=LocIP, port=LocPort)
        #  threaded=False,use_reloader=False,debug=False
