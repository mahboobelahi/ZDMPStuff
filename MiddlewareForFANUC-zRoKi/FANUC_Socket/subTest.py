...
def on_message(client, userdata, message):
    ...
    with open('img_file.png' , "wb") as fh:
...
def on_connect(client, userdata, flags, rc):
    if rc==0:
        ...
        print("[XXX]connected OK Returned code=",rc)
    else:
...
client.connect(host=z_MSG_URL, port=zMSG_PORT, keepalive=60)

client.subscribe("LR-Mate/d")
